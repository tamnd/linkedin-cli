# Build into bin/ (gitignored) so the binary never collides with the linkedin/
...
LDFLAGS := -s -w \
	...
	-X github.com/tamnd/linkedin-cli/cli.Commit=$(COMMIT) \
	-X github.com/tamnd/linkedin-cli/cli.Date=$(DATE)
